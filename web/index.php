        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-md-auto mb-2 mb-lg-0">
                    ...
                    <!-- <li class="nav-item">
                        <a class="nav-link" href="admin/katalog.php">Katalog</a>
                    </li> -->
                </ul>
                <ul class="navbar-nav me-md-auto mb-2 mb-lg-0 navigation">
                    <li class="nav-item me-2">
                        <a class="nav-link btn btn-outline-success" href="login/index.php">Log In</a>
                    </li>
                    <!-- <li class="nav-item">
                        <a class="nav-link btn btn-outline-success" href="signup/index.php">Sign Up</a>
                    </li> -->
                </ul>
                <!-- <form class="d-flex">
