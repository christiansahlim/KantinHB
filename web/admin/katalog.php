...
<body class="bg-dark">
    ...
    <div class="container">
        <h2 class="text-center text-white" style="margin-top: 150px;">Item List</h2>
        <input type="text" id="search" class="form-control mt-3 mb-5" placeholder="Search Item">
        <p class="text-center text-white">
            <a href="tambahKatalog.php">Add Item</a>
        </p>
